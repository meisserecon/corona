...
public class Simulation {
	...
	public Simulation(long seed, double lockdownThreshold) {
		...
		this.models.add(new Population("network adjusted r0", seed, SIZE, 1.65, lockdownThreshold, true));
	}
	...
	public static void main(String[] args) {
		long seed = 23;
		// double lockdownThreshold = 0.0; // set to 0.0 to disable lockdown 
		double lockdownThreshold = 0.7; // use this line to simulate lockdown
